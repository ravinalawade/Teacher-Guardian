...
<body>
    ...
    <?php
        ...
        if(!empty($_POST)){
            ...
            $q9  = "update prof_sub set Subject='$sub', Year=$year, Division='$div' where professor_id=$pid";
